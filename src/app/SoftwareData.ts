export const data = [
  {
    ...
    For the 3rd quarter final project at Turing's School of Software and Design, I took on the challenge of crafting an app that addresses this problem within a tight 6-day deadline. In this venture, I not only pushed my limits but also got my hands dirty with new technology such as OAuth2.0.
